<template>
  <div class="card">
    <form @submit.prevent="submit" class="card-body">
      <h2 class="card-title">Редактировать пост</h2>
      ...
      <p v-if="submitStatus === 'OK'" class="alert alert-success mt-4">Пост обновлен!</p>
  ...
  methods: {
    submit() {
      ...
      if (this.$v.$invalid) {
        ...
        Api.updatePost(this.postData).then(() => {
          this.$parent.$emit("postUpdated");
